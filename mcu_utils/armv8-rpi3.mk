...
COMPILE_FLAGS = -mcpu=cortex-m3 -mthumb -O2 -Wall -I$(CMSIS_PATH) -I$(HAL_PATH) --target=arm-linux-gnueabihf --gcc-toolchain=$(RASPBERRY_TOOL_PATH)/x-tools/armv8-rpi3-linux-gnueabihf/bin/
